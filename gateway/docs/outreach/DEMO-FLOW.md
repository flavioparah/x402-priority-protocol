...
| **"Quanto isso vai custar pros nossos clientes?"** | "Vocês definem. O `BASE_PRICE` e `MAX_PRICE` são env vars no shield. Default é US$ 0.0001 a US$ 0.005 por requisição em micro-lamports. Vocês ajustam pra qualquer lugar." |
