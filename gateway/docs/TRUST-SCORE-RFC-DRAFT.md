...
> Companion specs: [`QOS-COOPERATIVE-SPEC.md`](./QOS-COOPERATIVE-SPEC.md) (operator-side priority queueing), [`ESTRATEGIA.md`](./ESTRATEGIA.md) (business framing of the Trust-Score moat).
...
- [QOS-COOPERATIVE-SPEC.md](./QOS-COOPERATIVE-SPEC.md) — operator-side priority queue companion spec
